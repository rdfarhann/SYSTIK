        ...
        <header className="flex h-16 items-center border-b px-4 bg-background sticky top-0 z-20 shadow-sm border-slate-200">
          <div className="flex w-full items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <DropdownMenu>
              <DropdownMenuTrigger className="group flex items-center gap-3 rounded-full pl-1 pr-3 py-1 hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all outline-none">
                <UserAvatar 
                ...
                <div className="flex flex-col items-start mr-1 hidden md:flex">
                  <span className="text-[11px] font-black leading-tight text-slate-800 uppercase tracking-tight">
